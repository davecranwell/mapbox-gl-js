 ...
 * @param {bool} [options.pitchOnRotate=true] Control the map pitch in addition to the bearing
 */
function DragRotateHandler(map, options) {
    this._map = map;
    this._el = map.getCanvasContainer();
    this._bearingSnap = options.bearingSnap;
    this._pitch = options.pitchOnRotate !== false;
...
DragRotateHandler.prototype = {
    ...
    _onMove: function (e) {
        ...
        if (this._pitch) map.transform.pitch = pitch;
